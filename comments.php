...
<?php if (get_option('swt_authorback') == 'Display') { ?><?php echo WelcomeCommentAuthorBack($comment_author_email); ?><?php { echo '.'; } ?>	<?php } else { } ?>
	...
	<div id="comment-author-info">
        ...
        <!--根据是否是管理员来决定是否显示验证码-->
		<?php if (get_option('swt_math') == 'Display') { ?><p><?php if(!isset($_COOKIE['comment_author_email_'.COOKIEHASH]))spam_provent_math();?></p><?php { echo ''; } ?>	<?php } else { } ?>
	</div>
      <?php endif; ?>
