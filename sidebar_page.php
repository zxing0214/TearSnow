...
<div class="widget">
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('（页面）小工具①') ) : ?>
	<?php endif; ?>
</div>

<div class="widget"><div id="tab-title">
  <?php include('includes/t_tab_random.php'); ?>
</div></div>
...
<?php if (get_option('swt_adaa') == 'Display') { ?>
<div class="widget"><h3>广而告之</h3>
  <p><?php echo stripslashes(get_option('swt_adxxcode')); ?>
    <?php echo stripslashes(get_option('swt_adyycode')); ?>
    <?php echo stripslashes(get_option('swt_adzzcode')); ?></p>
</div>
<?php { echo ''; } ?><?php } else { } ?>
