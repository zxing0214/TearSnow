<?php if ( get_option( 'swt_type' ) == 'Display' ) { ?>
    ...
    <ul>
        ...
        foreach ( $counts as $count ) {
            ...
            $mostactive .= '<li class="mostactive">' . '<a href="' . $c_url . '" title="' . $count->comment_author . ' (留下' . $count->cnt . '个脚印)" target="_blank" rel="nofollow"><img src="' . $a . '" alt="' . $count->comment_author . '" class="avatar" /></a></li>';
        }
        echo $mostactive;
        ?>
    </ul>
    ...
    include(TEMPLATEPATH . '/includes/top_comment2.php');
}
