...
<div id="content">
    <div class="main">
        <?php if ( have_posts() ) : query_posts( $query_string . '&cat=' . get_option( 'swt_lists' ) );
                ...
                <ul <?php post_class(); ?> id="post-<?php the_ID(); ?>">
                    <li>
                        ...
                        <div class="article">
                            ...
                            <?php if ( is_sticky() ) echo '<img src="' . get_bloginfo( 'template_directory' ) . '/images/sticky.gif" />&nbsp;<span class="T_op">[置顶]</span>';the_title(); ?>
                                </a><span class="new"><?php include('includes/new.php'); ?></span></h2>
            ...
            <?php } else {
                include(TEMPLATEPATH . '/includes/thumbnail.php');
            } ?>
                    <?php {
                        echo '';
                    } ?><?php } else {
