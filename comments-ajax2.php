...
?>
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-author vcard">
			...
			<?php printf( __( '<cite class="fn">%s</cite>'), get_comment_author_link() ); ?><?php get_author_class($comment->comment_author_email,$comment->user_id)?>:<?php edit_comment_link( __( '编辑' ), ' ' ); ?>
		</div>
